...
# Docstring really should provide information that is useful to understanding what the object odes & also how to use it.
...
class Album:
    ...
    If not specified for, the artist will default to an artist with the name "Various Artists"
...
class Artist:
    """
    Basic class to store artist detalis.
        ...
        """ Add a new album to the list
         Args:
           album (album): album object ot add to the list.
            If the album is already present, it well not added again (although this is yet to implemented).
        """
    ...
    def add_song(self, name, year, title):
        ...
        Args:
            ...
            year (title) : The year the album was produced
            title (str) : The title of the song """
...
def load_data():
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            # data row should consist of (artist, albums, year, song)
        ...
        #         # We've just read details for a new artist                                                      # Deleted line# Store the current album in the currents artists collection then create a new artist object
        ...
        #         # we've just read a new album for the current artist                # Deleted line -  # Store the current album in the artist's collection then create a new album object
